...
class wpcues_basic_quiz{
		...
		*/
		public function wpcue_proquiz_admin_scripts(){
			global $wp_version;
			wp_register_script( 'wpcuebasicquiz-upload', plugins_url( '/js/wpcuebasicquiz-main.js', __FILE__ ),array('jquery','jquery-ui-core','jquery-ui-dialog','jquery-ui-tabs','jquery-ui-tooltip','postbox') );
